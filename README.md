...
> 机器学习算法接触下来比较抽象难懂，为了帮助自己理解，我将所有的算法用简洁易懂的文字进行总结，并且每个算法都附带了示例程序，这样总结+示例的做法使得我很快跨过了基础学习的阶段。
...
该 repo 资料来源于 Udemy 课程总结，对课程主讲老师、中文翻译、助教等工作人员表示感谢，版权属于原课程，此处只作为个人复习使用。
